...
# https://github.com/huangzhii/FCN-3D-pyjittor/blob/master/main3d.py
import jittor
...
class LUConv(nn.Module):
    def __init__(self, nchan, elu):
        ...
        self.bn1 = jittor.nn.BatchNorm3d(nchan)
...
class InputTransition(nn.Module):
    def __init__(self, in_channels, elu):
        ...
        self.bn1 = jittor.nn.BatchNorm3d(self.num_features)
    ...
    def forward(self, x):
        ...
        return self.relu1(jittor.add(out, x16))
...
class DownTransition(nn.Module):
    def __init__(self, inChans, nConvs, elu, dropout=False):
        ...
        self.bn1 = jittor.nn.BatchNorm3d(outChans)
    ...
    def forward(self, x):
        ...
        out = self.do1(down)
        out = self.ops(out)
        out = self.relu2(jittor.add(out, down))
        return out
...
class UpTransition(nn.Module):
    def __init__(self, inChans, outChans, nConvs, elu, dropout=False):
        ...
        self.bn1 = jittor.nn.BatchNorm3d(outChans // 2)
        self.do1 = passthrough
    ...
    def forward(self, x, skipx):
        ...
        xcat = jittor.cat((out, skipxdo), 1)
        out = self.ops(xcat)
        out = self.relu2(jittor.add(out, xcat))
        return out
...
class OutputTransition(nn.Module):
    def __init__(self, in_channels, classes, elu):
        ...
        self.bn1 = jittor.nn.BatchNorm3d(classes)
