...
if __name__ == "__main__":
    device = jittor.device('cuda' if jittor.cuda.is_available() else 'cpu')
    image_size = 64
    x = jittor.Tensor(1, 1, image_size, image_size, image_size)
    x = x.to(device)
